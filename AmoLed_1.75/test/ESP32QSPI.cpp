...
__attribute__((always_inline)) inline void Arduino_ESP32QSPI::CS_HIGH(void)
{
  dbg_func;
  *_csPortSet = _csPinMask;
}

__attribute__((always_inline)) inline void Arduino_ESP32QSPI::CS_LOW(void)
{
  dbg_func;
  *_csPortClr = _csPinMask;
}

__attribute__((always_inline)) inline void Arduino_ESP32QSPI::POLL_START()
{
  dbg_func;
  spi_device_polling_start(_handle, _spi_tran, portMAX_DELAY);
}

__attribute__((always_inline)) inline void Arduino_ESP32QSPI::POLL_END()
{
  dbg_func;
