...
private:
  ...
  volatile uint32_t * _csPortSet; // PORT register for chip select SET
  volatile uint32_t * _csPortClr; // PORT register for chip select CLEAR
