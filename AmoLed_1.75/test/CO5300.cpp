...
void Arduino_CO5300::setRotation(uint8_t r)
{
  ...
  {
  case 1:
    r = CO5300_MADCTL_RGB | CO5300_MADCTL_X_AXIS_FLIP;
    break;
  case 2:
    r = CO5300_MADCTL_RGB | CO5300_MADCTL_X_AXIS_FLIP | CO5300_MADCTL_Y_AXIS_FLIP; // flip horizontal and flip vertical
    break;
  case 3:
    r = CO5300_MADCTL_RGB | CO5300_MADCTL_Y_AXIS_FLIP;
    break;
  default: // case 0:
    r = CO5300_MADCTL_RGB;
    break;
